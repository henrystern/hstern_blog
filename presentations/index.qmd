...
format: 
    revealjs:
        theme: [dracula, presentation.scss]
...
```yml {style="font-size: 99%;" code-line-numbers="8|11-13|14-16"}
name: thispackage
channels:
  - conda-forge
dependencies:
...
2. These configure ruff, a static analysis tool, this is useful for maintaining a consistent code style across multiple collaborators. With these lint rules your editor will yell at you if you forget to document your code.
:::
...
Project parameters are defined in `thispackage.config`.
...
data_file = "C:/Users/steh/Projects/thispackage/data/productivity.csv"
```

Wrong
```python {code-line-numbers="false"}
data_file = "../data/productivity.csv"
```
...
raw_data_file = RAW_DATA_DIR / "productivity.csv"
```
