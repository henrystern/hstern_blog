...
$$\text{RRSP Return} = (\text{Savings} \times (1+r)^t) \times (1-\text{Future Tax Rate})$$
$$\text{TFSA Return} = (\text{Savings} \times (1-\text{Current Tax Rate})) \times (1+r)^t$$
$$\%\Delta = {\text{RRSP Return} \over \text{TFSA Return}} - 1 = {1-\text{Future Tax Rate} \over 1-\text{Current Tax Rate}}-1 = {\text{Current Tax Rate} - \text{Future Tax Rate} \over 1-\text{Current Tax Rate}}$$
